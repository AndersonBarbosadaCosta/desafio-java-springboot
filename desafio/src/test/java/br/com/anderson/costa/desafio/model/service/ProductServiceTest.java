...
public class ProductServiceTest {
    ...
    private void beforeEach() {
        ...
        this.productDtoExpected = new ProductDTO("1", "cadeira", "cadeira gamer pro", 899.56);
        this.productExpected = new Product(1, "cadeira", "cadeira gamer pro", 899.56);
    }
    ...
    public void mustReturnListProductsWithMinorPrice() {
        Mockito.when(mockRepository.findByPriceLessThanEqual(Mockito.anyDouble()))
    ...
    public void mustReturnListProductsWithPriceGreaterOrEqualsThan() {
        Mockito.when(mockRepository.findByPriceGreaterThanEqual(Mockito.anyDouble()))
                .thenReturn(products());
    ...
    public void mustReturnListProductsWithPriceMinorOrEqualsThanAndGreaterOrEqualsThan() {
        Mockito.when(mockRepository.findByPriceBetween(Mockito.anyDouble(), Mockito.anyDouble()))
                .thenReturn(products());
    ...
    public void mustNotReturnListProductsWithContainNameOrDescriptionEqual() {
        Mockito.when(mockRepository.findByNameContains(Mockito.anyString()))
                .thenReturn(Collections.singletonList(products().get(0)));
    ...
    public void mustReturnProductWhenIdValidIsPassed() {
        Mockito.when(mockRepository.findById(Mockito.anyInt())).thenReturn(Optional.of(productExpected));
    ...
    public void mustReturnListProductsWithFilterMinPrice() {
        Mockito.when(mockRepository.findByPriceLessThanEqual(Mockito.anyDouble())).thenReturn(products());
    ...
    public void mustReturnListProductsWithFilterMaxPrice() {
        Mockito.when(mockRepository.findByPriceGreaterThanEqual(Mockito.anyDouble())).thenReturn(products());
    ...
    public void mustReturnListProductsWithNameOrDescription() {
        Mockito.when(mockRepository.findByNameContains(Mockito.anyString())).thenReturn(Collections.singletonList(products().get(0)));
    ...
    public void mustReturnListProductsWithMinorAndGreaterAndNameOrDescription() {
        Mockito.when(mockRepository.findPriceBetweenNameEquals(Mockito.anyDouble(), Mockito.anyDouble(), Mockito.anyString())).thenReturn(products());
    ...
    public void mustReturnListProductsWithFilterBetweenMinAndMaxPrice() {
        Mockito.when(mockRepository.findByPriceBetween(Mockito.anyDouble(), Mockito.anyDouble())).thenReturn(products());
